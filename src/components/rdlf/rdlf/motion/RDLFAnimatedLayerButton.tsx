...
type RDLFAnimatedLayerButtonProps = {
...
export const RDLFAnimatedLayerButton = React.forwardRef<
  HTMLButtonElement | HTMLAnchorElement,
  RDLFAnimatedLayerButtonProps
>(
  (
    {
      className,
    ...
    const baseClassName = cn(
      "group relative inline-flex h-[52px] min-w-[184px] items-center justify-center overflow-hidden rounded-full border border-[#F5F0E1]/12",
      "bg-[#F5F0E1] px-7 text-sm font-semibold text-[#073534]",
      "shadow-[7px_7px_0px_#041F1F] transition-all duration-300 ease-out",
      "hover:translate-y-[5px] hover:shadow-[3px_3px_0px_#041F1F]",
      "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F5F0E1]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#041F1F]",
    ...
    const content = (
      <>
        <svg
          className={cn(
            "pointer-events-none absolute h-auto transition-all duration-500 ease-out",
            "w-[64px] -left-[34px] group-hover:left-0 group-hover:w-full",
            "rdlf-layer-spin",
          )}
        ...
        <span className="relative z-10 transition-colors duration-300 group-hover:text-[#F5F0E1]">
          {children}
        </span>
      </>
    );
...
RDLFAnimatedLayerButton.displayName = "RDLFAnimatedLayerButton";